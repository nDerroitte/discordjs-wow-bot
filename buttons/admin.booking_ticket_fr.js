...
module.exports =
{
    ...
    async execute(interaction)
    {
        ...
        embed = em.getEmbed(`Hello ${interaction.member.displayName}`, "Comment peut-on t'aider ?\nLaisse ta demande ici, un advertiser te contactera dès que possible.", 0x3399ff, "")
		...
		await new_channel.send(`Hello ${interaction.member.toString()}, un de nos advertisers <@&${lib.fr_adv_role_id}> te contactera dès que possible!`)
